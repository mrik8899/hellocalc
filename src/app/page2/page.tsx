...
export default function Page2() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-start p-4 space-y-4">
      {/* Navbar */}
      <Navbar />
  ...
  <span className="flex items-center gap-2">
    <img src="https://flagcdn.com/w40/pk.png" alt="Pakistan Flag" className="w-6 h-4 rounded-sm" />
    PK amount
  </span>
          <button
